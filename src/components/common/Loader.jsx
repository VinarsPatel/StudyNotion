...
export const Loader = () => {
   return (
      <div className='h-full flex items-center justify-center'>
         <div className="body"><svg className="pencil bg-richblack-800 rounded-full" viewBox="0 0 200 200" width="200px" height="200px" xmlns="http://www.w3.org/2000/svg">
            <defs>
            ...
            <g className="pencil__rotate" transform="translate(100,100)">
               ...
               <g className="pencil__point" transform="rotate(-90) translate(49,-30)">
                  ...
                  <polygon fill="hsl(223,25%,25%)" points="15 0,20 10,10 10" />
               </g>
            </g>
         </svg></div>
      </div>
