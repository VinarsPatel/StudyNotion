...
const { resetPasswordLinkTemplate } = require("../mails/templates/resetPasswordLinkTemplate");
   ...
   try {
      ...
      if (!user) {
         return res.status(404).json({
            success: false,
            message: 'Your email is not registered with us. Kindly first create an account.'
         });
      }
