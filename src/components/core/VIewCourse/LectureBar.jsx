...
const LectureBar = ({ course, setVideo, id }) => {
  ...
  return (
    <div className="flex h-full flex-shrink-0 flex-col gap-3 bg-richblack-800 py-7">
      <div className="mx-6 flex flex-col gap-3 border-b border-richblack-600 pb-4">
        ...
        <IconBtn text={"Add Review"} customClasses={"w-fit h-[45%]"} onclick={()=>{setModalData({
         btn1Handler:handleAddReview,
      ...
      {modalData && <ReviewModal modalData={modalData} s/>}
    </div>
  )
}
