          ...
          <table className="w-full table-auto ">
            <thead>
              <tr className="text-richblack-100">
                ...
                <th className="appearance-none pl-[5px] text-left font-medium">
                  Duration
                </th>
                <th className="appearance-none pl-[5px] text-left font-medium">
                  Price
              ...
              {courses.map((course) => {
                return (
                  <tr className="" key={course._id}>
                    <td className="flex gap-6 pt-[2rem]">
                      <img
                      ...
                      <div className="flex flex-col gap-3">
                        ...
                        <p className="overflow-hidden text-ellipsis  text-sm font-normal text-richblack-100">
                          {course.description}
                        </p>
                    ...
                    <td className="pl-[5px] text-richblack-100 ">
